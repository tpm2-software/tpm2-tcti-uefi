# Release Process:
This document describes the general process that maintainers must follow when making a release of the `tpm2-uefi` library.
...
```
$ gpg --verify tpm2-uefi-X.Y.Z.tar.gz.asc
```
